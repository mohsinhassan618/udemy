...
<?php get_header() ?>
    ...
    <section id="content">
        ...
        <div class="content-wrap">
            ...
            <?php
            if( !is_single() && is_home() && function_exists('wpp_get_mostpopular')  && get_theme_mod('ju_show_header_popular_post_widget') ){
                wpp_get_mostpopular(array (

                        'wpp_start'          =>     '<div class="section header-stick bottommargin-lg clearfix" style="padding: 20px 0;">
                                                         <div>
                                                            <div class="container clearfix">
                                                              <span class="label label-danger bnews-title">' . get_theme_mod('ju_popular_posts_widgets_title') . '</span>
...
echo '<pre>';
//print_r($wpdb);
//print_r($wp_filter['excerpt_length']);
echo '</pre>'
