            ...
            <div class="panel-body">
                ...
                <form method="post" action="admin-post.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="rating_login_required">
                            <option value="1">No</option>
                            <option value="2" <?php echo $recipe_opts['rating_login_required'] == 2 ? 'SELECTED' : ''; ?> >
                                Yes
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="recipe_submission_login_required">
                            <option value="1">No</option>
                            <option value="2" <?php echo $recipe_opts['recipe_submission_login_required'] == 2 ? 'SELECTED' : ''; ?> >
                                Yes
                            </option>
                        </select>
                    </div>
