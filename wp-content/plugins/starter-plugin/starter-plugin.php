 ...
 * Plugin URI:        www.starter-plugin.com
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            mohsin
 * Author URI:        mohsin.com
 * License:           GPL-2.0+
 ...
 * This action is documented in includes/class-starter-plugin-activator.php
 */
function activate_starter_plugin() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-starter-plugin-activator.php';
...
function deactivate_starter_plugin() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-starter-plugin-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-starter-plugin.php';
